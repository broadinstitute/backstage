...
if command -v op >/dev/null; then
    ...
    if [ ! -f "${SCRIPT_DIR}/github-app-backstage-bits-dev-credentials.yaml" ]; then
        op --account broadinstitute.1password.com read \
            --out-file "${SCRIPT_DIR}/github-app-backstage-bits-dev-credentials.yaml" \
            "op://BITS - Backstage/github-app-backstage-bits-dev-credentials/github-app-backstage-bits-dev-credentials.yaml"
    fi
else
    echo "1Password CLI not found. Please install it to use this script."
fi
